...
if (FALSE)
{
  ...
  save(arima_model_list, file = "ILI_state_auto_arima.RData")  
} else
{
...
save(arima_result_list, file = "ILI_state_auto_arima_results.RData")
```
...
save(covid_result_list, file = "covid_results.Rdata")
```
...
save(arima_plus_result_list, file = paste0("ILI_state_arima_plus_", today_date, ".Rdata"))
...
write_csv(state_template, 
          path = file.path("state-forecast-data", "bertcarnell-arima_glm",

...
today_date <- "2020-05-08" # before Sunday, Friday is best
...
current_ili_week <- 18 # max(model_data_post$week)
current_ili_year <- 2020
current_ili_date <- as.Date("2020-04-26") # Sunday - MMWRweek(current_ili_date)

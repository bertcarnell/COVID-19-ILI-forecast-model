...
today_date <- "2020-04-17" # before Sunday, Friday is best
...
current_ili_week <- 15 # max(model_data_post$week)
current_ili_year <- 2020
current_ili_date <- as.Date("2020-04-05") # Sunday - MMWRweek(current_ili_date)

...
today_date <- as.Date("2020-07-17") # Sys.Date() - Friday

current_ili_week <- 28 # max(model_data_post$week)
current_ili_year <- 2020
current_ili_date <- as.Date("2020-07-05") # Sunday - MMWRweek(current_ili_date)

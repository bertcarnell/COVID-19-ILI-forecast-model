...
today_date <- as.Date("2020-05-29") # Sys.Date() - Friday

current_ili_week <- 21 # max(model_data_post$week)
current_ili_year <- 2020
current_ili_date <- as.Date("2020-05-17") # Sunday - MMWRweek(current_ili_date)

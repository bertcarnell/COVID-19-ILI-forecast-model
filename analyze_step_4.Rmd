...
today_date <- "2020-04-10" # before Sunday, best if Friday
current_ili_week <- 14 # max(model_data_post$week)
current_ili_year <- 2020
current_ili_date <- as.Date("2020-03-29") # Sunday - MMWRweek(current_ili_date)

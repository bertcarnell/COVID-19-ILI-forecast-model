...
- Expected value: `r round(c(matrix(bin_centers, nrow = 1, byrow = TRUE) %*% arima2_fcst_result$p_bin), digits = 2)`
...
plot_data <- data.frame(
  ili = rep(bin_centers, times = k_col),
...
ggplot(plot_data) +  
  geom_histogram(aes(x = ili, y = ..density.., weight = prob), 
                 breaks = arima2_fcst_result$bins, position = "identity") +
  facet_grid(week ~ .) +
  theme_bw() +
